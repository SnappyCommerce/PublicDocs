...
| flags | "forcedTermsAndConditions": false, "limitedInstagramBot": false, "limitedWhatsappBot": false, "limitedFacebookBot": false, "GPTsatisfactionSurvey": false, "satisfactionSurvey": true | Personalized values are allowed |
...
To make files and comment mandatory, instead of putting them in "optionals", put tem in "requirements".
