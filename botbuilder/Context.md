...
| createTicket -> default -> requirements (Infracommerce) | ticketReason, ticketSubreason, comment | ticketReason, ticketSubreason, comment, files, orderNumber, documentNumber, any additional data that the bot should ask for |
